...
<nav class="navbar">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="./verPecas.php" class="nav-link"><i class="fa-solid fa-eye"></i> Pecas Disponiveis</a>
            </li>
            <li class="nav-item">
                <a href="./verPecas.php" class="nav-link"><i class="fa-solid fa-eye-slash"></i> Pecas Indisponiveis</a>
            </li>
            <hr>
